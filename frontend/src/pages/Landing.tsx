...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: 'Calories, protein, carbohydrates, fat, and sodium are summarized in one dashboard sourced from Temple dining data.',
  },
  {
    icon: TipsAndUpdatesIcon,
    title: 'Smart Insights',
    description: 'Receive prompts to balance your day when logged meals push you over or under your target macros.',
  },
  {
    icon: SchoolIcon,
    title: 'Made for Students',
    description: 'TempleCals was built by Temple University students to fit campus schedules, dining plans, and nutrition goals.',
  },
];
...
const Landing = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#ffffff', color: palette.charcoal }}>
        ...
        <Container maxWidth="lg">
          <Stack spacing={{ xs: 6, md: 8 }} alignItems="center" textAlign="center">
            <Stack spacing={2} maxWidth={720}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 400, color: 'text.secondary', lineHeight: 1.6 }}>
                TempleCals helps Temple University students stay on top of their health with an easy-to-use nutrition
                dashboard powered by real campus dining data.
              </Typography>
            </Stack>
            ...
            >
              <Stack spacing={3}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <Typography variant="subtitle2" sx={{ fontWeight: 600, color: palette.cherry }}>
                    Dashboard Preview
                  </Typography>
      ...
      <Box component="section" id="features" sx={{ bgcolor: palette.softGrey, py: { xs: 10, md: 12 } }}>
        <Container maxWidth="lg">
          <Stack spacing={1.5} sx={{ textAlign: 'center', mb: 6, alignItems: 'center' }}>
            ...
            >
              TempleCals brings together campus dining menus, nutrition facts, and goal tracking so you can focus on
              learning, training, and living well.
            </Typography>
          </Stack>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              <Stack spacing={2}>
                <Typography variant="overline" sx={{ letterSpacing: 2, fontWeight: 600, color: palette.cherry }}>
                  VISUALIZE PROGRESS
                </Typography>
                ...
                <Typography variant="body1" sx={{ color: 'text.secondary', lineHeight: 1.7 }}>
                  Detailed charts break down calories, protein, carbs, fat, and sodium pulled directly from meal entries.
                  Monitor streaks, spot trends, and adjust plans before the day ends.
                </Typography>
              </Stack>
            </Grid>
            <Grid item xs={12} md={6}>
                  ...
                  >
                    <Stack spacing={1.5}>
                      ...
                      <Typography variant="body2" sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                        TempleCals highlights when you are above or below goal so you can adjust your next meal instead
                        of waiting until the week ends.
                      </Typography>
                    </Stack>
                  </Box>
                </Stack>
      ...
      <Box component="section" sx={{ bgcolor: palette.softGrey, py: { xs: 10, md: 12 } }}>
        <Container maxWidth="lg">
          <Stack spacing={2} sx={{ textAlign: 'center', mb: 6 }}>
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 640, mx: 'auto' }}>
              These reflections come straight from TempleCals progress reviews and planning sessions with the project
              team.
            </Typography>
          </Stack>
          <Grid container spacing={3}>
            {testimonials.map((testimonial) => (
              <Grid key={testimonial.quote} item xs={12} md={6}>
                ...
                >
                  ...
                  <Stack spacing={0.5}>
                    <Typography variant="subtitle1" sx={{ fontWeight: 600, color: palette.cherry }}>
                      {testimonial.source}
                    </Typography>
                    <Typography variant="caption" sx={{ color: 'text.secondary' }}>
                      {testimonial.context}
        ...
        <Container maxWidth="md">
          <Stack spacing={3} alignItems="center" textAlign="center">
            ...
            <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 540 }}>
              Create your TempleCals account to log meals, set goals, and see every macro in one dashboard built for
              Temple University life.
            </Typography>
      ...
      <Box component="footer" sx={{ bgcolor: '#0f0f10', color: '#f5f5f5', py: 6 }}>
        <Container maxWidth="lg">
            ...
            <Stack direction="row" spacing={3} flexWrap="wrap" justifyContent="center" sx={{ gap: 2 }}>
              {footerLinks.map((link) => (
                <Link
                  ...
                  href={link.href}
                  underline="none"
                  sx={{ color: '#f5f5f5', opacity: 0.75, fontSize: 14, '&:hover': { opacity: 1 } }}
                >
                  {link.label}
                </Link>
              ))}
